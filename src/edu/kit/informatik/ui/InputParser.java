...
/**
 * Class that includes methods to parse different inputs for correct format.
 * 
...
public final class InputParser {
    ...
    private static final Pattern DAWN_PATTERN = Pattern.compile(StringList.DAWN_MCOORDINATE_PATTERN.toString()
    ...
    /**
     * Method to check if multiple coordinates are in the correct format. The number of coordinates depends on {@code length}.
     * @param input The coordinates to check.
    ...
    /**
     * Method to check if coordinates for a DAWN piece are in the correct format.
     * @param input The coordinates to check.
     * @return The coordinates.
     * @throws InvalidInputException If the coordinates are not in the correct format.
     */
